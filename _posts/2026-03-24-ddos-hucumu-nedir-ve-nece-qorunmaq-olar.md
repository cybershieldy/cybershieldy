...
# DDoS Hücumu Nədir? Sistem Necə Çökür, Necə Baş Verir və Necə Qorunmaq Olar?

İnternetdə bəzən bir saytın, serverin və ya tətbiqin qəfil yavaşladığını, cavab vermədiyini və ya tamamilə dayandığını görürük. Çox hallarda bunun arxasında sadə texniki problem yox, **DDoS hücumu** dayanır.
...
- DDoS hücumu necə yaranır?
- Sistem necə çökür?
- Botnet nədir?
- DDoS hücumlarının əsas növləri hansılardır?
- Server və saytlar niyə cavab vermir?
- DDoS hücumundan necə qorunmaq olar?
...
Yəni sistem “sındırılmaya” da bilər, amma **işləməz hala gətirilə bilər**.

## DDoS nədir?

**DDoS (Distributed Denial of Service)** — eyni məqsədi daşıyan, amma bunu **bir çox cihazdan eyni anda** edən hücum növüdür.
...
DDoS hücumunun məntiqi çox sadə görünür:

**hədəfə o qədər çox sorğu göndərilir ki, sistem artıq real istifadəçilərə cavab verə bilmir.**

Bu vəziyyəti real həyatda belə düşün:

Bir mağazanın qapısından eyni anda 20 nəfər keçəndə problem olmur. Amma eyni anda 50 min nəfər qapıya hücum etsə:
...
## 2. Hücum üçün cihazlar hazırlanır
...
## 5. Xidmət dayanır və ya ciddi zəifləyir
...
Bəzən şəbəkə güclü olur, server də ayaqda qalır, amma tətbiqin özü sıradan çıxır.
...
Bu hücumlar çox vaxt “kütləvi trafik” hücumları kimi görünür.
...
Bu tip hücumlar bəzən çox böyük bandwidth tələb etməsə də, server infrastrukturu üçün çox ağır ola bilər.

---

## 3. Application Layer DDoS

Bu ən “ağıllı” və bəzən ən təhlükəli növlərdən biridir.
...
Burada hücumçu adi istifadəçi kimi görünən request-lər göndərir. Ona görə də bunları ayırmaq bəzən çətin olur.

Ən təhlükəli tərəfi budur ki:
...
## Təhlükəsizlik baxımından zərərlər
...
Bu səbəbdən DDoS tək başına yox, bəzən daha böyük hücum planının bir hissəsi kimi düşünülməlidir.
...
SOC və Blue Team baxımından bunlar vacib siqnallardır.
...
- pattern əsaslı filtr tətbiq edə bilər
- bot davranışını ayıra bilər
- bəzi Layer 7 hücumlarını bloklaya bilər

## 4. Load balancing və autoscaling

Yükü bir serverdə toplamaq risklidir.

Daha dayanıqlı memarlıq:
...
## 5. Firewall və ACL optimizasiyası
...
## 6. DDoS protection xidməti istifadə et

Bəzi hallarda ixtisaslaşmış anti-DDoS xidmətləri lazımdır. Xüsusilə:
...
## 7. Monitoring və SIEM inteqrasiyası

Erkən aşkarlama çox vacibdir.
...
## 8. Incident response plan hazır olmalıdır

DDoS zamanı “indi nə edək?” demək gec ola bilər.
...
# DDoS Hücumu Etik Hacking və Kiber Təhlükəsizlik Dərslərində Niyə Vacib Mövzudur?

Bu mövzu yalnız hücum kimi yox, **müdafiə, monitorinq və memarlıq** mövzusu kimi də öyrənilməlidir.

Çünki bu sahədə çalışan biri aşağıdakıları anlamalıdır:

- trafik necə işləyir
- şəbəkə resursları necə tükənir
- web server performansı necə düşür
- bot ilə real user traffic fərqi necə aşkarlanır
- SIEM və IDS/IPS bu hücumu necə görür
- Blue Team necə reaksiya verir
- Red Team bu riski necə modelləşdirir

Yəni DDoS anlayışı **hacker dərsləri**, **kiber təhlükəsizlik dərsləri**, **etik hacking dərsləri**, **cyber security kursları**, **Red Team**, **Blue Team** və **SOC analitikası** üçün bazadır.

---

# DDoS Hücumuna Qarşı Güclü İnfrastruktur Necə Qurulur?
...
- [OSINT Araşdırmaları: Açıq Mənbələrdən Məlumat Toplama və Analiz](https://cybershieldy.com/posts/osint-arastirmalari)
